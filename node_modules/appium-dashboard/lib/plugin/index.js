...
class AppiumDashboardPlugin extends base_plugin_1.default {
    ...
    constructDesiredCapabilities(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((rawCapabilities === null || rawCapabilities === void 0 ? void 0 : rawCapabilities["platformName"].toLowerCase()) == "android" && !(rawCapabilities === null || rawCapabilities === void 0 ? void 0 : rawCapabilities["appium:mjpegServerPort"])) {
