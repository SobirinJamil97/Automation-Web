...
class Devices {
    ...
    isBrowserStack() {
        return this.host.cloudName.toLowerCase() === Cloud_1.default.BROWSERSTACK;
    }
    isPCloudy() {
        return this.host.cloudName.toLowerCase() === Cloud_1.default.PCLOUDY;
    }
    isLambdaTest() {
        return this.host.cloudName.toLowerCase() === Cloud_1.default.LAMBDATEST;
    }
    isSauceLabs() {
        return this.host.cloudName.toLowerCase() === Cloud_1.default.SAUCELABS;
    }
}
